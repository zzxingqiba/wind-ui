  ...
  >
    ...
    <template v-else>
      <textarea
        ...
        @change="handleChange"
      ></textarea>
      <template v-if="showWordLimitVisible">
        <div :class="textareaCountKls">
          <span :class="textareaCountInnerKls"
            >{{ textLength }} / {{ attrs.maxlength }}</span
          >
        </div>
      </template>
...
import { useAttrs } from '@wind/hooks'
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const textareaInnerKls = [nsTextarea.e('inner')]
    const textareaCountKls = [nsTextarea.e('count')]
    const textareaCountInnerKls = [nsTextarea.e('count-inner')]
